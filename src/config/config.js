...
const configSchemas = {
  ...
  HF_API_KEY: { type: 'string', default: '', sensitive: true },
  HF_API_URL: { type: 'string', default: 'https://api-inference.huggingface.co/models/DavidAU/L3-Stheno-Maid-Blackroot-Grand-HORROR-16B-GGUF' },
